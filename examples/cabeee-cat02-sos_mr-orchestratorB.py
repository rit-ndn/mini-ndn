...
WORKFLOW = MININDN_DIR + '/workflows/cat02-map_reduce.json'
TOPOLOGY = MININDN_DIR + '/topologies/cabeee-cat02-star_of_stars.conf'
...
SERVICE_BIN = BIN_DIR + '/cabeee-dag-serviceB-app'
ORCHESTRATOR_BIN = BIN_DIR + '/cabeee-dag-orchestratorB-app'
...
def run():
    ...
    if routeOption == 2:
        ...
        #nfds = AppManager(ndn, ndn.net.hosts, Nfd, logLevel="INFO")
        nfds = AppManager(ndn, [ndn.net['sensor0']], Nfd, logLevel="INFO", csSize=0)
        nfds = AppManager(ndn, [ndn.net['rtr0']], Nfd, logLevel="INFO", csSize=1000)
        ...
        nfds = AppManager(ndn, [ndn.net['rtr4']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr5']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr6']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr7']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr8']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr9']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr10']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr11']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr12']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr13']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr14']], Nfd, logLevel="INFO", csSize=1000)
        nfds = AppManager(ndn, [ndn.net['rtr15']], Nfd, logLevel="INFO", csSize=1000)
        ...
        grh.addOrigin([ndn.net['sensor0']], [PREFIX + "/sensor"])
        grh.addOrigin([ndn.net['rtr9']], [PREFIX + "/service0"])
        grh.addOrigin([ndn.net['rtr10']], [PREFIX + "/service1"])
        grh.addOrigin([ndn.net['rtr10']], [PREFIX + "/service2"])
        grh.addOrigin([ndn.net['rtr15']], [PREFIX + "/service3"])
        grh.addOrigin([ndn.net['rtr0']], [PREFIX + "/service4"])
        grh.addOrigin([ndn.net['rtr12']], [PREFIX + "/service5"])
        grh.addOrigin([ndn.net['rtr6']], [PREFIX + "/service6"])
        grh.addOrigin([ndn.net['sensor0']], [PREFIX + "/service7"])
        grh.addOrigin([ndn.net['rtr13']], [PREFIX + "/service8"])
        grh.addOrigin([ndn.net['rtr1']], [PREFIX + "/service9"])
        grh.addOrigin([ndn.net['rtr13']], [PREFIX + "/aggregator"])
    ...
    ndn.net['sensor0'].cmd(PRODUCER_BIN + ' {} {} {} {} {} {} {} > cabeee_producer.log &'.format(PREFIX, "/sensor", 9000, 0, 100, 1000, makespanNS))
    ...
    # SET UP THE FORWARDERS/SERVICES
    # run the application on all router nodes
    makespanNS = 0 # for now we don't use any CPU to run the services.
    ndn.net['rtr9'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service0.log &'.format(PREFIX, "/service0", makespanNS))
    sleep(0.1)
    ndn.net['rtr10'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/service1", makespanNS))
    sleep(0.1)
    ndn.net['rtr10'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service2.log &'.format(PREFIX, "/service2", makespanNS))
    sleep(0.1)
    ndn.net['rtr15'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service3.log &'.format(PREFIX, "/service3", makespanNS))
    sleep(0.1)
    ndn.net['rtr0'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service4.log &'.format(PREFIX, "/service4", makespanNS))
    sleep(0.1)
    ndn.net['rtr12'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service5.log &'.format(PREFIX, "/service5", makespanNS))
    sleep(0.1)
    ndn.net['rtr6'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service6.log &'.format(PREFIX, "/service6", makespanNS))
    sleep(0.1)
    ndn.net['sensor0'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service7.log &'.format(PREFIX, "/service7", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service8.log &'.format(PREFIX, "/service8", makespanNS))
    sleep(0.1)
    ndn.net['rtr1'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service9.log &'.format(PREFIX, "/service9", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_serviceagg.log &'.format(PREFIX, "/aggregator", makespanNS))
    sleep(0.1)


    # SET UP THE ORCHESTRATOR
    # run the cabeee-dag-orchestratorA-app application on consumer nodes
    ndn.net['user'].cmd(ORCHESTRATOR_BIN + ' {} {} > cabeee_orchestrator.log &'.format(PREFIX, "/serviceOrchestration"))
    ...
    ndn.net['user'].cmd(CONSUMER_BIN + ' {} {} {} > cabeee_consumer.log &'.format(PREFIX, WORKFLOW, 2))
