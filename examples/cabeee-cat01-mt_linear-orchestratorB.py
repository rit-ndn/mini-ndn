...
WORKFLOW = MININDN_DIR + '/workflows/cat01-linear.json'
TOPOLOGY = MININDN_DIR + '/topologies/cabeee-cat01-multi_tier.conf'
...
def run():
    ...
    if routeOption == 2:
        ...
        grh.addOrigin([ndn.net['rtr9']], [PREFIX + "/service2"])
        grh.addOrigin([ndn.net['rtr14']], [PREFIX + "/service3"])
        grh.addOrigin([ndn.net['rtr3']], [PREFIX + "/service4"])
        grh.addOrigin([ndn.net['rtr10']], [PREFIX + "/service5"])
        grh.addOrigin([ndn.net['rtr13']], [PREFIX + "/service6"])
        grh.addOrigin([ndn.net['sensor0']], [PREFIX + "/service7"])
        grh.addOrigin([ndn.net['rtr14']], [PREFIX + "/service8"])
        grh.addOrigin([ndn.net['rtr3']], [PREFIX + "/service9"])
        grh.addOrigin([ndn.net['rtr8']], [PREFIX + "/aggregator"])
    ...
    sleep(0.1)
    ndn.net['rtr9'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service2.log &'.format(PREFIX, "/service2", makespanNS))
    sleep(0.1)
    ndn.net['rtr14'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service3.log &'.format(PREFIX, "/service3", makespanNS))
    sleep(0.1)
    ndn.net['rtr3'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service4.log &'.format(PREFIX, "/service4", makespanNS))
    sleep(0.1)
    ndn.net['rtr10'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service5.log &'.format(PREFIX, "/service5", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service6.log &'.format(PREFIX, "/service6", makespanNS))
    sleep(0.1)
    ndn.net['sensor0'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service7.log &'.format(PREFIX, "/service7", makespanNS))
    sleep(0.1)
    ndn.net['rtr14'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service8.log &'.format(PREFIX, "/service8", makespanNS))
    sleep(0.1)
    ndn.net['rtr3'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service9.log &'.format(PREFIX, "/service9", makespanNS))
    sleep(0.1)
    ndn.net['rtr8'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_serviceagg.log &'.format(PREFIX, "/aggregator", makespanNS))
    sleep(0.1)
