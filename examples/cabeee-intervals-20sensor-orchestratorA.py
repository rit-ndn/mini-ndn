...
def run():
    ...
    ndn.net['rtr2'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceA-app {} {} {} > cabeee_serviceA_service21.log &'.format(PREFIX, "/serviceP21", makespanNS)
    ...
    cmd = BIN_DIR + '/cabeee-custom-app-consumer-poisson {} {} {} {} {} {} > cabeee_consumer.log &'.format(PREFIX, "/consumer", WORKFLOW, 1, 10, 100)
