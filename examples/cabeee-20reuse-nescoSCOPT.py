...
def run():
    ...
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/serviceP2")
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/serviceP3")
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/serviceP4")
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/serviceP5")
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/serviceP6")
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    ...
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service10.log &'.format(PREFIX, "/serviceP22")
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service10.log &'.format(PREFIX, "/serviceP23")
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-forwarder-app {} {} > cabeee_forwarder_service10.log &'.format(PREFIX, "/serviceR1")
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
