...
def run():
    ...
    cmd = '/home/cabeee/mini-ndn/examples/apps/dist/cabeee_producer {} > cabeee_producer.log &'.format(PREFIX)
    producer  = ndn.net['sensor']
    producer.cmd(cmd)

    # or one-liner
    #ndn.net['sensor'].cmd("/home/cabeee/mini-ndn/examples/apps/dist/cabeee_producer")
