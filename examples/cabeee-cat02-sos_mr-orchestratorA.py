...
SERVICE_BIN = BIN_DIR + '/cabeee-dag-serviceA-app'
ORCHESTRATOR_BIN = BIN_DIR + '/cabeee-dag-orchestratorA-app'
...
def run():
    ...
    ndn.net['user'].cmd(CONSUMER_BIN + ' {} {} {} > cabeee_consumer.log &'.format(PREFIX, WORKFLOW, 1))
