...
def run():
    ...
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceP2", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceP3", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceP4", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceP5", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceP6", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    sleep(0.1)
    ...
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service10.log &'.format(PREFIX, "/serviceP22", makespanNS)
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service10.log &'.format(PREFIX, "/serviceP23", makespanNS)
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service10.log &'.format(PREFIX, "/serviceR1", makespanNS)
    ndn.net['rtr3'].cmd(cmd)
    sleep(0.1)
