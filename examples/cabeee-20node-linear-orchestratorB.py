...
def run():
    ...
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service1.log &'.format(PREFIX, "/serviceL1", makespanNS)
    ndn.net['rtr1'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service2.log &'.format(PREFIX, "/serviceL2", makespanNS)
    ndn.net['rtr2'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service3.log &'.format(PREFIX, "/serviceL3", makespanNS)
    ndn.net['rtr3'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service4.log &'.format(PREFIX, "/serviceL4", makespanNS)
    ndn.net['rtr4'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service5.log &'.format(PREFIX, "/serviceL5", makespanNS)
    ndn.net['rtr5'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service6.log &'.format(PREFIX, "/serviceL6", makespanNS)
    ndn.net['rtr6'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service7.log &'.format(PREFIX, "/serviceL7", makespanNS)
    ndn.net['rtr7'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service8.log &'.format(PREFIX, "/serviceL8", makespanNS)
    ndn.net['rtr8'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service9.log &'.format(PREFIX, "/serviceL9", makespanNS)
    ndn.net['rtr9'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service10.log &'.format(PREFIX, "/serviceL10", makespanNS)
    ndn.net['rtr10'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service11.log &'.format(PREFIX, "/serviceL11", makespanNS)
    ndn.net['rtr11'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service12.log &'.format(PREFIX, "/serviceL12", makespanNS)
    ndn.net['rtr12'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service13.log &'.format(PREFIX, "/serviceL13", makespanNS)
    ndn.net['rtr13'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service14.log &'.format(PREFIX, "/serviceL14", makespanNS)
    ndn.net['rtr14'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service15.log &'.format(PREFIX, "/serviceL15", makespanNS)
    ndn.net['rtr15'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service16.log &'.format(PREFIX, "/serviceL16", makespanNS)
    ndn.net['rtr16'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service17.log &'.format(PREFIX, "/serviceL17", makespanNS)
    ndn.net['rtr17'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service18.log &'.format(PREFIX, "/serviceL18", makespanNS)
    ndn.net['rtr18'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service19.log &'.format(PREFIX, "/serviceL19", makespanNS)
    ndn.net['rtr19'].cmd(cmd)
    cmd = BIN_DIR + '/cabeee-dag-serviceB-app {} {} {} > cabeee_serviceB_service20.log &'.format(PREFIX, "/serviceL20", makespanNS)
