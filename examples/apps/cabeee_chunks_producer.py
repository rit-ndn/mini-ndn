...
def main():
    ...
    #name.append(Component.from_version(timestamp())) #cabeee: we can't append the timestamp, otherwise the route won't work!

    with open(sys.argv[2], 'rb') as f:
        data = f.read()
        seg_cnt = (len(data) + SEGMENT_SIZE - 1) // SEGMENT_SIZE # double slash is "floor division"
