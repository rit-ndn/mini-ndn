...
WORKFLOW = MININDN_DIR + '/workflows/cat04-wavefront.json'
TOPOLOGY = MININDN_DIR + '/topologies/cabeee-cat04-mesh.conf'
...
def run():
    ...
    if routeOption == 2:
        ...
        grh.addOrigin([ndn.net['rtr4']], [PREFIX + "/service0"])
        grh.addOrigin([ndn.net['rtr8']], [PREFIX + "/service1"])
        ...
        grh.addOrigin([ndn.net['sensor0']], [PREFIX + "/service5"])
        grh.addOrigin([ndn.net['rtr2']], [PREFIX + "/service6"])
        grh.addOrigin([ndn.net['rtr11']], [PREFIX + "/service7"])
        grh.addOrigin([ndn.net['rtr0']], [PREFIX + "/service8"])
        grh.addOrigin([ndn.net['rtr15']], [PREFIX + "/service9"])
        grh.addOrigin([ndn.net['rtr7']], [PREFIX + "/aggregator"])
    ...
    makespanNS = 0 # for now we don't use any CPU to run the services.
    ndn.net['rtr4'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service0.log &'.format(PREFIX, "/service0", makespanNS))
    sleep(0.1)
    ndn.net['rtr8'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/service1", makespanNS))
    sleep(0.1)
    ...
    sleep(0.1)
    ndn.net['sensor0'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service5.log &'.format(PREFIX, "/service5", makespanNS))
    sleep(0.1)
    ndn.net['rtr2'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service6.log &'.format(PREFIX, "/service6", makespanNS))
    sleep(0.1)
    ndn.net['rtr11'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service7.log &'.format(PREFIX, "/service7", makespanNS))
    sleep(0.1)
    ndn.net['rtr0'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service8.log &'.format(PREFIX, "/service8", makespanNS))
    sleep(0.1)
    ndn.net['rtr15'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service9.log &'.format(PREFIX, "/service9", makespanNS))
    sleep(0.1)
    ndn.net['rtr7'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_serviceagg.log &'.format(PREFIX, "/aggregator", makespanNS))
    sleep(0.1)
