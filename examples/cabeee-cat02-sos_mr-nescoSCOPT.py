...
def run():
    ...
    makespanNS = 0 # for now we don't use any CPU to run the services.
    ndn.net['rtr9'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service0.log &'.format(PREFIX, "/service0", makespanNS))
    sleep(0.1)
    ndn.net['rtr10'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/service1", makespanNS))
    sleep(0.1)
    ndn.net['rtr10'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service2.log &'.format(PREFIX, "/service2", makespanNS))
    sleep(0.1)
    ndn.net['rtr15'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service3.log &'.format(PREFIX, "/service3", makespanNS))
    sleep(0.1)
    ndn.net['rtr0'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service4.log &'.format(PREFIX, "/service4", makespanNS))
    sleep(0.1)
    ndn.net['rtr12'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service5.log &'.format(PREFIX, "/service5", makespanNS))
    sleep(0.1)
    ndn.net['rtr6'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service6.log &'.format(PREFIX, "/service6", makespanNS))
    sleep(0.1)
    ndn.net['sensor0'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service7.log &'.format(PREFIX, "/service7", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service8.log &'.format(PREFIX, "/service8", makespanNS))
    sleep(0.1)
    ndn.net['rtr1'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_service9.log &'.format(PREFIX, "/service9", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(FORWARDER_BIN + ' {} {} {} > cabeee_forwarder_serviceagg.log &'.format(PREFIX, "/aggregator", makespanNS))
    sleep(0.1)
