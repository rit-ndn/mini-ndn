...
WORKFLOW = MININDN_DIR + '/workflows/cat03-map_reduce.json'
TOPOLOGY = MININDN_DIR + '/topologies/cabeee-cat03-mesh.conf'
...
def run():
    ...
    if routeOption == 2:
        ...
        grh.addOrigin([ndn.net['rtr13']], [PREFIX + "/service0"])
        grh.addOrigin([ndn.net['rtr5']], [PREFIX + "/service1"])
        grh.addOrigin([ndn.net['rtr14']], [PREFIX + "/service2"])
        grh.addOrigin([ndn.net['rtr7']], [PREFIX + "/service3"])
        grh.addOrigin([ndn.net['rtr11']], [PREFIX + "/service4"])
        grh.addOrigin([ndn.net['user']], [PREFIX + "/service5"])
        grh.addOrigin([ndn.net['rtr13']], [PREFIX + "/service6"])
        grh.addOrigin([ndn.net['rtr1']], [PREFIX + "/service7"])
        grh.addOrigin([ndn.net['user']], [PREFIX + "/service8"])
        grh.addOrigin([ndn.net['rtr12']], [PREFIX + "/service9"])
        grh.addOrigin([ndn.net['rtr11']], [PREFIX + "/aggregator"])
    ...
    makespanNS = 0 # for now we don't use any CPU to run the services.
    ndn.net['rtr13'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service0.log &'.format(PREFIX, "/service0", makespanNS))
    sleep(0.1)
    ndn.net['rtr5'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service1.log &'.format(PREFIX, "/service1", makespanNS))
    sleep(0.1)
    ndn.net['rtr14'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service2.log &'.format(PREFIX, "/service2", makespanNS))
    sleep(0.1)
    ndn.net['rtr7'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service3.log &'.format(PREFIX, "/service3", makespanNS))
    sleep(0.1)
    ndn.net['rtr11'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service4.log &'.format(PREFIX, "/service4", makespanNS))
    sleep(0.1)
    ndn.net['user'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service5.log &'.format(PREFIX, "/service5", makespanNS))
    sleep(0.1)
    ndn.net['rtr13'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service6.log &'.format(PREFIX, "/service6", makespanNS))
    sleep(0.1)
    ndn.net['rtr1'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service7.log &'.format(PREFIX, "/service7", makespanNS))
    sleep(0.1)
    ndn.net['user'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service8.log &'.format(PREFIX, "/service8", makespanNS))
    sleep(0.1)
    ndn.net['rtr12'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_service9.log &'.format(PREFIX, "/service9", makespanNS))
    sleep(0.1)
    ndn.net['rtr11'].cmd(SERVICE_BIN + ' {} {} {} > cabeee_forwarder_serviceagg.log &'.format(PREFIX, "/aggregator", makespanNS))
    sleep(0.1)
